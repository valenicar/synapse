...
class DnsModelTest(SynTest):
    ...
    def test_model_dns_look(self):
        with s_cortex.openurl('ram:///') as core:
            ...
            t0 = core.formTufoByProp('inet:dns:look', None, a='WOOT.com/1.002.3.4')
            ...
            t0 = core.formTufoByProp('inet:dns:look', None, ns='WOOT.com/ns.yermom.com')
            ...
            t0 = core.formTufoByProp('inet:dns:look', None, rev='1.2.3.4/WOOT.com')
            ...
            t0 = core.formTufoByProp('inet:dns:look', None, aaaa='WOOT.com/FF::56')
